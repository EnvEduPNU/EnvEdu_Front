...
function Training(){
    return(
        ...
        <div className="container-fluid" id="con1">
           <h1>Training & Implementation</h1>
        </div>

        <div className="container">
        <div className="student">
        <br/><br/><h2><b>교사 연수</b></h2><hr/>
      
        <div className="row featurette" style={{ padding: '2em' }}>
        <div className="col-md-7 order-md-2">
          <h5 className="featurette-heading fw-normal lh-1">
          <br/><NavLink to='/tboard'>교사 연수</NavLink><br/><span className="text-muted"></span>
          </h5>
          <p id="te">
        ...
        <div className="student">
        <br/><h2><b>현장적용</b></h2><hr/>
      
        <div className="row featurette" style={{ padding: '2em' }}>
        <div className="col-md-7 order-md-2">
          <h3 className="featurette-heading fw-normal lh-1">
          <br/> <NavLink to='/tboard'>현장적용</NavLink><span className="text-muted"></span>
          </h3>
          <ul className="lead">
            <li>유초등 현장적용 현장</li>
            <li>중학교 현장적용 현장
        ...
        <div className="col-md-5 order-md-1">
        <NavLink to='/tboard'><img src={train1} width="100%" /></NavLink>
        </div>
      </div>
      ...
      <div className="student">
      <br/><br/><h2><b>사회환경지도사 연수</b></h2><hr/>
      
      <div className="row featurette" style={{ padding: '2em' }}>
        <div className="col-md-7 order-md-2">
          <h5 className="featurette-heading fw-normal lh-1">
          <br/><NavLink to ='/tboard'>사회환경지도사 연수</NavLink><br/><span className="text-muted"></span>
          </h5>
          <ul className="lead">
