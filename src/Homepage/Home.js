      ...
      <>
        <Carousel className='carousel'>
          <Carousel.Item interval={6000}>
            <div className="carousel-img item1">
              ...
              <div className='typing-container'>SEEd는 환경 데이터 측정 및 그래프 그리기, 온라인 클래스 생성을 지원하는 플랫폼이에요. </div>
              <Link to='/'>
                <button className='detail-button' style={{ animationDelay: '5s' }}>자세히 보기</button>
              </Link>
            </div>
          </Carousel.Item>
          ...
          <Carousel.Item interval={6000}>
            <div className="carousel-img item2">
              ...
              <div className='text-container'>스마트 환경 모니터링 Kit, 환경 교육 프로그램 자료 및 온라인 코스웨어를 개발했어요. <br/>자세한 내용은 아래 링크에서 볼 수 있어요.</div>
              <Link to='/what'>
                <button className='detail-button' style={{ animationDelay: '1.5s' }}>자세히 보기</button>
              </Link>
            </div>
          </Carousel.Item>
        </Carousel>
        ...
        <div className='shortcut-container'>
          <CustomCard>
            <img src={cardImg1}/>
            <h4>SEEd App</h4>
            <span>SEEd 측정 기기로 습도, 이산화탄소, 조도 등 다양한 값을 측정할 수 있어요.</span>
            <div style={{ display: 'flex', justifyContent: 'end', width: '80%', marginTop: '1rem' }}>
              <Link to="/socket">
          ...
          <CustomCard>
            <img src={cardImg2} />
            <h4>Data & Chart</h4>
            <span>SEEd App으로 측정한 값을 바탕으로 그래프를 그릴 수 있어요.</span>
            <div style={{ display: 'flex', justifyContent: 'end', width: '80%', marginTop: '1rem' }}>
              <Link to="/">
                <StartButton>START</StartButton>
              </Link>
          ...
          <CustomCard>
            <img src={cardImg4} />
            <h4>Data Literacy</h4>
            <span>데이터를 읽고 그 안에 숨겨진 의미를 파악하는 활동을 할 수 있어요.</span>
            <div style={{ display: 'flex', justifyContent: 'end', width: '80%', marginTop: '1rem' }}>
