        ...
        <div className="box">
          ...
          <div className="row featurette" style={{ padding: '2em' }}>
            <div className="col-md-7 order-md-2">
              ...
              <p>SEM-kit 1.0와 연동하는 스마트디바이스 어플리케이션을 SEM-kit 2.0에서 구동하는 웹 서버와 스마트디바이스에서 구동하는 웹 어플리케이션을 개발함으로써 다음 그림과 같이 접근 가능한 스마트디바이스의 종류가 무선통신(예, 무선랜, 블루투스)이 가능한 스마트디바이스로 대폭 확장되며, 웹 프로토콜을 통해 여러 대의 스마트디바이스에서 한 대의 SEM-kit 2.0에 동시접속이 가능(1:多) 할 뿐 아니라 여러 대의 SEM-kit 2.0에서 측정되는 데이터를 접속가능한 모든 스마트 디바이스에서 표현 및 처리 가능(多;1 또는 多:多)하게 된다. <br />
                이러한 기능들을 원활하게 사용할 수 있도록, 웹 기반 애플리케이션의 접속 모드를 관리자 모드와 관찰자 모드로 나누어 개발한다. 관리자 모드는 측정, 센서 보정, 데이터 변환, 출력모드 선택 등 SEM-kit 2.0의 모든 기능을 활용할 수 있도록 하며, 관찰자 모드는 관리자 모드에서 지정한 기능만 활용 가능하도록 개발하여 다중 접속 및 다기기 접속 과정에서 발생하는 혼선을 줄인다.
                <br /><br />1) 웹 어플리케이션에서 이산화탄소 센서의 보정기능 추가
                <br />2) 장비 및 센서의 온오프 점검기능</p>
            </div>
